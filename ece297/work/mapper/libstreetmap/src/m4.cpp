...
//std::vector<unsigned> converted_path;
//
//void converter(unsigned int_id1, unsigned int_id2, unsigned place){
//    for(unsigned i =0; i< getNumberOfStreetSegments() ; i++){
//        if(getStreetSegmentInfo(i).from == int_id2 && getStreetSegmentInfo(i).from == int_id1 ){
//              converted_path[place] = i;
//        }
//        if(getStreetSegmentInfo(i).from == int_id1 && getStreetSegmentInfo(i).from == int_id2  ){
//              converted_path[place] = i;
//        }
//    }
//    
...
//    std::vector<unsigned> path_street;
//    
//    
...
//    distance_threads.clear();
//    
//    resize_intersection_distances_multithreaded(path.size());
//
//    for (unsigned i = 0; i < path.size(); i++){
//        distance_threads.push_back(std::thread(&initial_distance_dijkstra2,path[i], path, turn_penalty, i));
//    }
//    
//     for (unsigned i = 0; i < path.size(); i++){
...
//    }
//    
//    distances = return_intersection_distances_multithreaded();
//    
//    
...
//    
//    
//    std::vector<std::thread> conversion;
//    conversion.clear();
//    
//    converted_path.resize(path.size()-1);
//
//    for (unsigned i = 0; i< path.size()-1; i++){
//       conversion.push_back(std::thread(&converter, path[i], path[i+1], i));
//    }
//    
//    for (unsigned i = 0; i< path.size()-1; i++){
//       conversion[i].join();
