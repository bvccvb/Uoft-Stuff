...
class ReadFileWriteFile {  
	public static void main (String[] args) { 
		...
		try {  
			...
			int iBytes = 0, pBytes = 0, bBytes = 0;
			int num_iBytes = 0, num_pBytes = 0, num_bBytes = 0;
			...
			System.out.println("I frame: " + (float) iBytes/num_iBytes);
			System.out.println("P frame: " + (float) pBytes/num_pBytes);
			System.out.println("B frame: " + (float) bBytes/num_bBytes); 
